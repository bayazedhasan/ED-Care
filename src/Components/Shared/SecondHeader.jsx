...
const SecondHeader = () => {
    ...
    return (
        <div>
            <div className='flex items-center justify-between container mx-auto px-28 p-4'>
                <Link href={"/"}><div>
                ...
                <div>
                    <div className="w-150">
                        <div className="flex items-center border border-[#BCE3C9] border-none bg-[#F2F4F7] rounded-full  transition-colors p-1">
                            ...
                            >
                                ...
                                >
                                    ...
                                    Categories <FaAngleDown className={`${open ? "rotate-180" : ""} transition-all`} />
                                </button>
                ...
                <div>
                    <div className='flex items-center gap-3'>
                        <div className='text-[#6E7271] border rounded-full p-1 cursor-pointer'>
                            <img className='w-8 text-[#6E7271]' src="/assets/pngtree-love-interface-line-vector-single-icon-image_319675-removebg-preview.png" alt="" />
                        </div>
                        <div className='border rounded-full p-2 border-[#6E7271] cursor-pointer'>
                            <TiShoppingCart size={25} color='#6E7271' />
                        </div>
                        <div className='border rounded-full px-8 cursor-pointer  py-3 border-none bg-[#07A698]'>
